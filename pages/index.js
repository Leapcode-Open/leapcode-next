    ...
    return(
      <LandingPageLayout>
        <div>
          <div className="max-w-screen-lg mx-auto mt-12 md:mt-32">
            <div className="flex">
              ...
              <div className="w-full md:w-2/3 px-6 md:px-0">
                <img alt='Leapcode Logo' className="md:w-1/4 w-1/2 mb-12" src={'/logo.svg'} />
                <h1 className="md:leading-tight w-full text-3xl md:text-5xl text-newblue-900 font-gt mb-6 font-bold">{}Kick start your  open <br /> source contribution{}</h1>
                <p className=" font-gt text-base md:text-lg text-newblue-900 leading-tight tracking-wide letter">Leapcode helps you contribute to open source projects right from your first pull request to working on major projects</p>
                    ...
                    <a href="/dashboard" rel="nofollow" className=" hover:bg-gray-800 hover:shadow-md duration-100 bg-black text-white font-gt inline-block font-semibold px-6 py-3 text-sm md:text-sm rounded-lg ">
                      <div className="flex items-center">
                        <span>Go to dashboard</span>
                          <span className="w-5 h-5 text-white ml-2"><ChevronRight /></span>
                        </div>
                    </a>
                    }
                ...
                <div className="grid gap-4 md:grid-cols-3 text-left mt-12 px-4">
                    {
                      contributors.filter(c => c.data.username != 'sethusathyan').map(contrib => (
                        <Link key={contrib.slug} href={`/contributor/${contrib.slug}`}>
                          <a  className="border cursor-pointer border-gray-300 p-3 bg-white shadow-sm hover:shadow-lg transition transition-duration-100 rounded">
          ...
          <div>
                  <FlyingUsers contributors={featuredUsers} />
                  <Link href="/contributor">
                    <a className="text-blue-600 font-bold font-gt mt-10 block hover:underline text-center" >See all contributors →</a>
                  </Link>
          ...
          <div className=" mt-12 md:mt-32 text-center bg-newblue-800 py-12 md:py-32 strokes-bg">
            <div className="max-w-screen-md mx-auto px-6 md:px-2">
              <h2 className="text-3xl md:text-4xl font-gt text-white font-bold">Contributing to open source is now <br />easy & rewarding</h2>
              <p className="font-gt text-white  leading-relaxed tracking-wide mt-8">A lot of first time contributors face issues in finding a project, figuring out what to contribute, understanding the repo etc. With Leapcode, we are empowering first time contributors by motivating & rewarding each step they take towards the contribution.</p>
          ...
          <section className="md:mt-32 mt-16" >
            <div className="max-w-screen-lg mx-auto flex flex-col md:flex-row ">
              <div className="md:w-3/6 px-6 md:px-0">
                ...
                <p className="text-newblue-900 tracking-wide font-gt mt-8" >For open source project maintainers & owners, Leapcode helps you onboard first time contributors by simplyfying your contribution process & making it interesting.</p>
